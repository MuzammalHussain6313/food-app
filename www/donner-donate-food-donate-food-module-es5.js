...
var DonateFoodPage = /** @class */ (function () {
    function DonateFoodPage(route, http, formBuilder, service, router) {
        this.route = route;
        this.http = http;
    ...
    DonateFoodPage.prototype.ngOnInit = function () {
        ...
        this.route.paramMap.subscribe(function (paramMap) {
            ...
            console.log('id', _this.charityID);
        });
    ...
    DonateFoodPage.prototype.donateFood = function () {
        ...
        var foodDonation = JSON.parse(this.finalDonationObject);
